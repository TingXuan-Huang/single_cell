...
description: >-
  Use for AI/ML work in scientific domains such as biology, chemistry,
  physics, genomics, medicine, climate, materials science, astronomy,
  protein design, molecules, single-cell, or theorem proving. Helps discover
  and use Hugging Science catalog resources, Hugging Face datasets/models,
  scientific Spaces, transformers, datasets, gradio_client, and related
